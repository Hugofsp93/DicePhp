...
<html>
	...
	<body>
		<div class="container">
			...
			<br>
			<br>
			<form action="php_action/create.php" method="post" data-toggle="validator" role="form">
				<div class="form-group">
					<label for="text">Nome:</label>
					<input type="text" class="form-control" name="nome" placeholder="Qual nome do projeto?" data-error="Por favor, informe o nome do projeto." required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group">
					<label for="number">Duração:</label>
					<input type="number" class="form-control" name="duracao" placeholder="Qual a duração do projeto?" data-error="Por favor, informe a duração do projeto." required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group">
					<label for="number">Integridade:</label>
					<input type="number" class="form-control" name="integridade" placeholder="Qual a integridade do projeto?" data-error="Por favor, informe a integridade do projeto." required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group">
					<label for="number">Comprometimento da Gerência:</label>
					<input type="number" class="form-control" name="c1" placeholder="Compromentimento da diretoria" data-error="Por favor, informe o comprometimento da diretoria no projeto." required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group">
					<label for="number">Comprometimento dos Funcionários:</label>
					<input type="number" class="form-control" name="c2" placeholder="Compromentimento dos funcionários" data-error="Por favor, informe o comprometimento dos funcionários no projeto." required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group">
					<label for="number">Esforço:</label>
					<input type="number" class="form-control" name="esforco" placeholder="Qual o esforço do projeto?" data-error="Por favor, informe o esforço do projeto." required>
					<div class="help-block with-errors"></div>
				</div>
